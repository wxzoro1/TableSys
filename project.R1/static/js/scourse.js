...
function edit_public(sn) {
    function put_public() {
        ...
        console.log($('#frm-public input[name="courseno"]').val())
        item['cname'] = $('#frm-public input[name="cname"]').val();
        item['credit'] = $('#frm-public input[name="credit"]').val();
        item['property'] = $('#frm-public select[name="property"]').val();
    ...
    .then(function(item) {
        ...
        $('#frm-public input[name="cname"]').val(item['cname']);
        $('#frm-public input[name="credit"]').val(item['credit']);
        $('#frm-public select[name="property"]').val(item['property']);
...
function register_public() {
    ...
    $('#frm-public input[name="cname"]').val('');
    $('#frm-public input[name="credit"]').val('');
    $('#frm-public select[name="property"]').val('');
